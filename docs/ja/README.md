...
| [視覚リファレンス mockup](../mockups/README.md) | Rails app を起動せずに baseline output と interaction state を確認する static HTML/CSS リファレンス。最初の俯瞰には [review-gallery.html](../mockups/review-gallery.html) を使ってください。 |
...
baseline の DOM 構造や interaction state を静的に確認したい場合は [視覚リファレンス mockup](../mockups/README.md) を参照し、最初は [review-gallery.html](../mockups/review-gallery.html) から俯瞰してください。
