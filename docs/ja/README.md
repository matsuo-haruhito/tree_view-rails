...
| [Migration guide](migration.md) | upgrade 時の互換性、deprecation、rename、release note の見方 |
...
| [Migration guide](migration.md) | 互換性の約束、deprecation、release note 期待値を upgrade 観点で整理したガイド |
...
upgrade 判断、deprecation、release note の見方は [Migration guide](migration.md) を参照してください。
