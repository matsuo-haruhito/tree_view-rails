...
baseline の DOM 構造や interaction state を静的に確認したい場合は [視覚リファレンス mockup](../mockups/README.md) を参照し、最初は [review-gallery.html](../mockups/review-gallery.html) から俯瞰し、focused な確認には [resource-table-bridge.html](../mockups/resource-table-bridge.html) と [toolbar-actions.html](../mockups/toolbar-actions.html) を使ってください。
