...
| [視覚リファレンス mockup](../mockups/README.md) | Rails app を起動せずに baseline output と interaction state を確認する static HTML/CSS リファレンス |
...
baseline の DOM 構造や interaction state を静的に確認したい場合は [視覚リファレンス mockup](../mockups/README.md) を参照してください。
