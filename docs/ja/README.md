...
| [Selection checkbox hooks](selection-checkbox-hooks.md) | 描画済み selection checkbox class と disabled reason attribute の package-root hook。selection behavior と送信値は Selection 本体にします |
