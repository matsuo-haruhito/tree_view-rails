...
| [視覚リファレンス mockup](../mockups/README.md) | Rails app を起動せずに baseline output と interaction state を確認する static HTML/CSS リファレンス。最初の俯瞰には [review-gallery.html](../mockups/review-gallery.html) を使い、focused な構造確認には [resource-table-bridge.html](../mockups/resource-table-bridge.html) と [toolbar-actions.html](../mockups/toolbar-actions.html) を使い、小さな幅での hierarchy 確認には [narrow-sidebar-tree.html](../mockups/narrow-sidebar-tree.html) を使い、loading・error・drag/drop state の確認には [interaction-states.html](../mockups/interaction-states.html) を使い、root item が無い場合や no-results の empty row 確認には [empty-state.html](../mockups/empty-state.html) を使ってください。 |
...
baseline の DOM 構造や interaction state を静的に確認したい場合は [視覚リファレンス mockup](../mockups/README.md) を参照し、最初は [review-gallery.html](../mockups/review-gallery.html) から俯瞰し、focused な構造確認には [resource-table-bridge.html](../mockups/resource-table-bridge.html) と [toolbar-actions.html](../mockups/toolbar-actions.html) を使い、小さな幅での hierarchy 確認には [narrow-sidebar-tree.html](../mockups/narrow-sidebar-tree.html) を使い、loading・error・drag/drop state の確認には [interaction-states.html](../mockups/interaction-states.html) を使い、root item が無い場合や no-results の empty row 確認には [empty-state.html](../mockups/empty-state.html) を使ってください。
