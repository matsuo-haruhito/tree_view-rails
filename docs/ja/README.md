...
| [視覚リファレンス mockup](../mockups/README.md) | Rails app を起動せずに baseline output と interaction state を確認する static HTML/CSS リファレンスです。最初の見比べには [review-gallery.html](../mockups/review-gallery.html) を開いてください。 |
...
baseline の DOM 構造や interaction state を静的に確認したい場合は、まず [review-gallery.html](../mockups/review-gallery.html) を開き、必要に応じて [視覚リファレンス mockup](../mockups/README.md) から個別ページを参照してください。
