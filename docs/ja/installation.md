...
GitHub Actions では、Pull Requestで `bundle exec standardrb`、`bundle exec rspec`、JavaScript checks を実行します。

`main` へのpushでは、Ruby/Rails matrices、JavaScript tests、gem package verificationを実行します。