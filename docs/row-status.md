# Row disabled and readonly states

TreeView can mark an entire row as disabled or readonly without moving the business rule into the gem.
...
Disabled rows receive:

- `tree-view-row--disabled`
- `aria-disabled="true"`
- `data-tree-view-row-disabled="true"`

Readonly rows receive:

- `tree-view-row--readonly`
- `data-tree-view-row-readonly="true"`
