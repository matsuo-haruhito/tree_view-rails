...
5. Use [row-status-depth-labels.html](row-status-depth-labels.html) when review needs to compare row-wide readonly or disabled cues, selection availability, and depth-label meaning boundaries.
