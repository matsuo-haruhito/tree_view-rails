...
if (missingSignals.length > 0) {
  console.error("[public-api-transfer-integration-docs-signals] missing documentation signals:")
...
console.log(
  `[public-api-transfer-integration-docs-signals] ${requiredManifestSignals.length} manifest signals, ${requiredPublicApiSignals.length} Public API signals, and ${requiredDragAndDropSignals.length} Drag and Drop signals are present`
)
